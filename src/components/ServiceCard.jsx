...
const ServiceCard = ({ service, index }) => {
    ...
    return (
        ...
        dark:shadow-white/10' onMouseEnter={() => setVisible(true)} onMouseDownCapture={() => setVisible(false)}>
            ...
            absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? 'opacity-70' : 'opacity-0'}`} style={{
                    top: position.y - 150,
                    left: position.x - 150,
                }} />
            ...
            <div className='flex items-center gap-10 p-8 hover:p-7.5 hover:m-0.5
                ...
                <div className='bg-gray-100 dark:bg-gray-700 p-4 rounded-full'>
                    <img src={service.icon} alt='' className='max-w-24 bg-white dark:bg-gray-900
                        rounded-full m-2' />
                </div>
